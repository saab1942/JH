Public Class frmContratistas
    ...
    Private Sub btneditar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btneditar.Click
        ...
        If ContratistaDataGridView.RowCount = 0 Then
        ...
        btnGuardar.Enabled = True
        ContratistaDataGridView.Enabled = False
    ...
    Private Sub btnGuardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGuardar.Click
        ...
        If abm = "agregar" Then
            ContratistaTableAdapter.InsertQuery(NombreTextBox.Text, ApellidoTextBox.Text, DireccionTextBox.Text, TelefonoTextBox.Text, EmailTextBox.Text)
        End If

        If abm = "editar" Then
            ContratistaTableAdapter.UpdateQuery(NombreTextBox.Text, ApellidoTextBox.Text, DireccionTextBox.Text, TelefonoTextBox.Text, EmailTextBox.Text, Val(IdcontratistaTextBox.Text))
        End If
        ...
        ContratistaDataGridView.Enabled = True

        ContratistaTableAdapter.Fill(JH2DataSet.contratista)
    ...
    Private Sub btnborrar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnborrar.Click
        ...
        If MsgBox("Esta a punto de Borrar este cliente", MsgBoxStyle.YesNo, "Borrar") = 6 Then
            ContratistaTableAdapter.DeleteQuery(Val(IdcontratistaTextBox.Text))
    ...
    Private Sub btnExportar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnExportar.Click
        ...
        For i As Integer = 1 To Me.ContratistaDataGridView.Columns.Count
            worksheet.Cells(1, i) = Me.ContratistaDataGridView.Columns(i - 1).HeaderText
        Next

        'Aca se ingresa el detalle recorrera la tabla celda por celda

        For i As Integer = 0 To Me.ContratistaDataGridView.Rows.Count - 1
            For j As Integer = 0 To Me.ContratistaDataGridView.Columns.Count - 1
                worksheet.Cells(i + 2, j + 1) = Me.ContratistaDataGridView.Rows(i).Cells(j).Value.ToString()
            Next
        Next
